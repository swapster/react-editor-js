...
var EditorJsContainer = /** @class */ (function (_super) {
    ...
    function EditorJsContainer(props) {
        ...
        if (props.holderId) {
            if (typeof props.holderId === 'string') {
                _this.holder = props.holderId;
            }
            if (props.holderId instanceof HTMLElement) {
                _this.holder = props.holderId.id;
            }
        }
        else {
